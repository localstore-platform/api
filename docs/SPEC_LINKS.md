...
This document provides curated links to relevant specifications from the [localstore-platform/specs](https://github.com/localstore-platform/specs) repository (v1.0-specs).
...
- [Project README](https://github.com/localstore-platform/specs/blob/v1.0-specs/README.md)
- [Architecture Overview](https://github.com/localstore-platform/specs/blob/v1.0-specs/architecture/overview.md)
- [Contributing Guidelines](https://github.com/localstore-platform/specs/blob/v1.0-specs/CONTRIBUTING.md)
